    ...
    def scheduling_dp_loop(self):
        ...
        while True:
            ...
            # rdp drs
                ...
                if rdp_drs_type == DominantRdpShareType.DPS_RDP_alpha_positive:
                    self._cal_drs_rdp_a_positive()


                elif rdp_drs_type == DominantRdpShareType.DPS_RDP_alpha_all:
        ...
        while True:
            ...
            if len(waiting_task_cn_mapping) > 0:
                ...
                fair_allocation = max_min_fair_allocation(
                    desired=desired_dp, capacity=this_block["residual_dp"]
                )
